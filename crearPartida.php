...
<?php require_once 'includes/nav.php';?>
            ...
            foreach($_SESSION['partida'] as $p){              
              ...
              echo 
                ' <td>
                    <div class="row">
                      <div class="col-5">
                      <form method="POST" action="formEditarPartida.php">
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <form method="POST" action="borrarPartida.php">
  ...
  <div class="row">
    <div class="col-auto">
      <button class="btn btn-primary ms-auto" onclick="location.href='formPartida.php'">
					Agregar Partida
			</button>
    </div>
    <div class="col-auto">
			<button type="submit" class="btn btn-primary ms-auto" onclick="location.href='finalizar.php'">
					Finalizar
			</button> 
  </div>
  </div>

...
$_SESSION['indexP'] = $_SESSION['requisicion'][$num]['partida'][$_POST['partida']];
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<div  class="text-center my-5">
      ...
      <div class="row">
        <table class="table table-bordered text-center my-5">
          ...
          <tbody>
            <?php
            $partidas = $_SESSION['requisicion'][$num]['partida'][$_POST['partida']];
            
              echo '<tr>';
              $index = $_POST['partida'];
              $_SESSION['indexP'] = $_POST['partida'];
...
<h3>Ingrese los datos que desea modificar</h3>
    <form method="POST" class="needs-validation" action="editPartidaG.php">
      <div class="row">
        <div class="col-4">
